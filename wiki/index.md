...
Catalog of all synthesized knowledge in this project.

- [Log](log.md) - Chronological record of operations.
- [Features](features/status.md) - Project status and feature catalog.
  - [Core Features](features/core.md) - Detailed currently implemented features.
